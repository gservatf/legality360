...
const App = () => {
  ...
  useEffect(() => {
    const initializeAuth = async () => {
      try {
        ...
        console.log('Auth initialized:', { user: !!user, profile });
  ...
  const handleLogin = async () => {
    try {
      ...
      console.log('Login handler:', { user: !!user, profile });
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            {/* Professional Routes (Analista/Abogado) */}
            <Route 
            ...
            <Route path="/analista/dashboard" element={<Navigate to="/professional/dashboard" replace />} />
            <Route path="/abogado/dashboard" element={<Navigate to="/professional/dashboard" replace />} />
            <Route path="/cliente/dashboard" element={<Navigate to="/client/dashboard" replace />} />
