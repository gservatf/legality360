...
export default function TaskEditModal({ task, isOpen, onClose, onSave, userRole }: TaskEditModalProps) {
  ...
  const handleDateSelect = (date: Date | undefined) => {
    ...
    if (date) {
      setFormData(prev => ({
        ...prev,
        fecha_limite: format(date, 'yyyy-MM-dd')
      }));
    }
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="p-4 bg-gray-50 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4 text-xs text-gray-600">
              ...
              <div>
                <span className="font-medium">Fecha de creación:</span> {format(new Date(task.fecha_creacion), 'dd/MM/yyyy')}
              </div>
              <div>
