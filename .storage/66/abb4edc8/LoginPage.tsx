...
export default function LoginPage({ onLogin }: LoginPageProps) {
  ...
  const [loginForm, setLoginForm] = useState({
    email: 'contacto@inandinas.com', // Pre-fill demo credentials
    password: 'demo123'
  })
  ...
  const handleDemoLogin = async () => {
    ...
    try {
      const result = await authService.signInWithEmail('contacto@inandinas.com', 'demo123')
      ...
      const authError = err as AuthError
      setError(authError.message || 'Error en login demo')
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="mx-auto w-16 h-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center mb-4">
            <span className="text-white font-bold text-xl">L360°</span>
          </div>
        ...
        <div className="text-center mt-6 text-sm text-gray-600">
          <div className="p-4 bg-white/50 rounded-lg">
            ...
            <p><strong>Cliente:</strong> contacto@inandinas.com / demo123</p>
            <p><strong>Analista:</strong> analista@legality360.com / analyst123</p>
          </div>
        </div>
      </div>
    </div>
